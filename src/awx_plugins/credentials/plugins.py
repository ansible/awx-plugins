...
github_app_token = ManagedCredentialType(
    ...
    managed=True,
    # do I need a custom injector? I don't know...
    inputs={
        'fields': [
            {
                'id': 'github_url',
            ...
            },
            {
                ...
                'help_text': gettext_noop(
                    ...
                    'Example: 59980338 '
                    'he  Installation ID from the GitHub App installation generated by the GitHub Admin '
                    'Example: 59980338 '
        ...
        'required': ['install_id','ssh_key_data',],
    },
)
...
github_app_plugin = CredentialPlugin("GitHub App Authentication", inputs=github_app_token, backend=github_app_backend)
